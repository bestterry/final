                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="alert alert-success alert-dismissible">
                                                    ...
                                                    <h4><i class="icon fa fa-check"></i> เสร็จสิ้น</h4>
                                                    ระบบทำการเรียบเปลี่ยนรหัสผ่านของท่านเรีบยร้อย
                                                </div>
                                                <a href="data_customer.php" class="btn btn-info"><span class="fa fa-mail-reply"></span> ย้อนกลับ</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
