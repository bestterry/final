    ...
    <div class="box box-solid">
        ...
        <div class="box-body no-padding">
            <ul class="nav nav-pills nav-stacked">
                        ...
                        <form action="manage_tool_withdraw.php" method="post" target="_blank">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <font size="3"><B><i class="fa fa-minus-square"></i> ถอนอุปกรณ์ </B></font>
                                </div>
                                <div class="modal-body col-md-12 table-responsive mailbox-messages">
                                    <div class="form-group">
                                        <label for="txttoolid"> วัตถุประสงค์</label>
                                        <br>
                                        <label class="radio-inline "><input type="radio" name="type" value="ติดตั้งน้ำประปา" checked>ติดตั้งน้ำประปา</label>
                                        <br>
                ...
                <!-- //เเก้ไขอุปกรณ์  -->
                <!--เพิ่มรายการอุปกรณ์ -->
                <li><a href="#" data-toggle="modal" data-target="#myModal3"><i class="fa fa-plus"></i> เพิ่มรายการอุปกรณ์ </a></li>
                    ...
                    <div class="modal-dialog modal-lg">
                        <form action="algorithm/insert_tool.php" method="get">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                                    <font size="3"><B><i class="fa fa-plus"></i> เพิ่มรายการอุปกรณ์ </B></font>
                                </div>
                                <div class="modal-body">
                                    <div class="form-group">
                                        <?php
                                ...
                                <div class="modal-footer">
                                    <button type="submit" class="btn btn-success pull-left" onclick="if(confirm('ยืนยันการบันทึก')) return true; else return false;">บันทึก</button>
                                    <button type="button" class="btn btn-danger" data-dismiss="modal">ปิด</button>
                                </div>
                            </div>
                        </form>
