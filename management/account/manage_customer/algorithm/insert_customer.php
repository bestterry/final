...
require '../../../../connect/connect.php';
    ...
    //insert user
    $sql = "INSERT INTO customer(customer_id,name,lastname,birth,Email,Phone,card_number,career,sex)
        VALUES ('$str_userid_check','$name','$lastname','$birth','$email','$phone','$card_number','$career','$sex')";
...
header('location:../insert_customer_success.php');
