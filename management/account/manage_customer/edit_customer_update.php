                            ...
                            <div role="form">
                                ...
                                <div class="box-footer">
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <button type="submit" name="btnSubmit1" value="Submit" class="btn btn-primary pull-left" onclick="return confirm('ยืนยันการแก้ไขข้อมูล')"><i class="fa  fa-arrow-circle-o-down"></i> บันทึกข้อมูล</button>
                                    </div>
                                    <div class="col-md-5"></div>
                                </div>
                                <!-- /.box-footer -->
