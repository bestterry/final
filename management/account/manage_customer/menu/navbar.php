<section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
        <li class="treeview ">
            ...
            <ul class="treeview-menu">
                <li><a href="edit_customer.php"><i class="fa fa-circle-o"></i>จัดการเเก้ไขข้อมูลผู้ใช้้นำ</a></li>
                <li><a href="status_customer.php"><i class="fa fa-circle-o"></i>จัดการสถานะผู้ใช้น้ำ</a></li>
                <li><a href="check_customer.php"><i class="fa fa-circle-o"></i>ตรวจสอบข้อมูลผู้ใช้น้ำประปา</a></li>
            </ul>
        </li>
        <!-- ข้อมูลสถิติ  -->
        <li class="treeview">
