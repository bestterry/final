...
$objr_check_house = mysqli_fetch_array($objq_check_house);
 $address = $objr_check_house['address'];
 $village_no = $objr_check_house['village_no'];
...
$query_count = $conn->query($sql_count_check_row);
    ...
    if ($count==0){ // ยังไม่มีข้อมูล
        ...
        $sql="INSERT INTO meter_management(meter_id,meter_previos,meter_after,meter_united,money,unit_price_id,house_id,employee_id) VALUE ('$meter_id','$meter_previos','$meter_after','$meter_united','$money','$unit_price_id','$meter_id','$employee_id')";
