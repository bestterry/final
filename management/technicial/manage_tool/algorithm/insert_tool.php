...
if ($result['description_tool']){
    ...
    $sql = "INSERT INTO description_tool(description_tool_id, name_tool, num_tool, price_tool, unit)
                 VALUES ('".$_GET['txttoolid']."','".$_GET['txtname_tool']."','".$_GET['txtnum']."','".$_GET['txtprice']."','".$_GET['unit']."')";
