...
require 'sesion.php';
require ('fpdf.php');
require '../manage_customer/menu/time_format.php';
$customer_id=$_GET['customer_id'];
$sql_name = "SELECT * FROM house INNER JOIN customer ON customer.customer_id=house.customer_id WHERE customer.customer_id='$customer_id'";
...
//หาพิกัดที่วางชื่อ
$pdf->Text(165 ,  33, iconv( 'UTF-8','cp874' , 'เทศบาลตำบลบ้านถ้ำ' ) , 0 , 1 , 'C');
$pdf->Text(170 ,  43, iconv( 'UTF-8','cp874' , DateThai(date('Y-m-d')) ) , 0 , 1 , 'C');
 $pdf->Text(35 ,  94, iconv( 'UTF-8','cp874' , $objr_name['name'] ) , 0 , 1 , 'C');
 $pdf->Text(50 ,  94, iconv( 'UTF-8','cp874' , $objr_name['lastname']) , 0 , 1 , 'C');
 $pdf->Text(105, 94, iconv( 'UTF-8','cp874' , $objr_name['age']) , 0 , 1 , 'C');
 $pdf->Text(31 ,  101, iconv( 'UTF-8','cp874' , DateThai($objr_name['birth'])) , 0 , 1 , 'C');
 $pdf->Text(90 ,  101, iconv( 'UTF-8','cp874' , $objr_name['card_number']) , 0 , 1 , 'C');
$pdf->Text(172 ,  101, iconv( 'UTF-8','cp874' , DateThai($objr_name['exp_card_number'])) , 0 , 1 , 'C');
 $pdf->Text(36 ,  108, iconv( 'UTF-8','cp874' , $objr_name['address'] ) , 0 , 1 , 'C');
//  $pdf->Text(108 ,  129, iconv( 'UTF-8','cp874' , $numh ) , 0 , 1 , 'C');
 $pdf->Text(60 ,  108, iconv( 'UTF-8','cp874' , $objr_name['village_no'] ) , 0 , 1 , 'C');
...
// $pdf->Text(170 ,  101, iconv( 'UTF-8','cp874' , $exp ) , 0 , 1 , 'C');
 $pdf->Text(80 ,  108, iconv( 'UTF-8','cp874' , '-' ) , 0 , 1 , 'C');
 $pdf->Text(152 ,  129, iconv( 'UTF-8','cp874' , '-' ) , 0 , 1 , 'C');
 $pdf->Text(108 ,  115, iconv( 'UTF-8','cp874' , $objr_name['career'] ) , 0 , 1 , 'C');
 $pdf->Text(165 ,  115, iconv( 'UTF-8','cp874' , $objr_name['workplace'] ) , 0 , 1 , 'C');
 $pdf->Text(35 ,  122, iconv( 'UTF-8','cp874' , $objr_name['Phone'] ) , 0 , 1 , 'C');
 $pdf->Text(105 ,  129, iconv( 'UTF-8','cp874' , $objr_name['address'] ) , 0 , 1 , 'C');
 $pdf->Text(130 ,  129, iconv( 'UTF-8','cp874' , $objr_name['village_no'] ) , 0 , 1 , 'C');
 $pdf->Text(131 ,  204, iconv( 'UTF-8','cp874' , $objr_name['name'] ) , 0 , 1 , 'C');
 $pdf->Text(144 ,  204, iconv( 'UTF-8','cp874' , $objr_name['lastname']) , 0 , 1 , 'C');
...
// $pdf->Text(160 ,  43, iconv( 'UTF-8','cp874' , $date ) , 0 , 1 , 'C');
...
$pdf->Cell(0  ,  5, iconv( 'UTF-8','cp874' , 'วันที่ ...................................................' ),0,1,'R');
$pdf->Ln(5);
...
$pdf->cell(5 , 7, iconv( 'UTF-8','cp874' ,'มีความประสงค์จะดำเนินการตามข้อ........1.........  สำหรับบ้านเลขที่.................  หมู่ที่..................  ถนน........................  ตำบล.....บ้านถ้ำ.......'),0,1);
...
$pdf->Text(66 ,  44, iconv( 'UTF-8','cp874' , date('d') ) , 0 , 1 , 'C');
$pdf->Text(85 ,  44, iconv( 'UTF-8','cp874' , DateThaiMonth(date('m')) ) , 0 , 1 , 'C');
$pdf->Text(118 ,  44, iconv( 'UTF-8','cp874' , DateThaiYear(date('Y')) ) , 0 , 1 , 'C');
$pdf->Cell(0  ,  7, iconv( 'UTF-8','cp874' , '             สัญญาฉบับนี้ทำขึ้น เมื่อวันที่..........  เดือน.................................. พ.ศ................. ณ สำนักงานเทศบาลตำบลบ้านถ้ำ' ) , 0 , 1);
$pdf->Text(30 ,  51, iconv( 'UTF-8','cp874' , $obj_employee['name'].'        '.$obj_employee['lastname'] ) , 0 , 1 , 'C');
$pdf->Text(127 ,  51, iconv( 'UTF-8','cp874' , $objr_name['name'].'        '.$objr_name['lastname'] ) , 0 , 1 , 'C');
$pdf->Text(187 ,  51, iconv( 'UTF-8','cp874' , $objr_name['address'] ) , 0 , 1 , 'C');
$pdf->Text(25 ,  58, iconv( 'UTF-8','cp874' , $objr_name['village_no'] ) , 0 , 1 , 'C');
