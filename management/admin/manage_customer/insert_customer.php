...
<script language="javascript">
    function fncSubmit()
    {
        ...
        if(document.form1.workplace.value == "")
        {
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box box-info">
                            <div class="box-header with-border">
                                ...
                                <br>
                                <font color="red" size="3">*กรุณากรอกข้อมูลให้ครบทุกช่อง ถ้าไม่มีระบุ(-)</font>
                            </div>
                            <div role="form">
                                <div class="box-body">
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group col-md-3">
                                            <label for="txtlastname">วันบัตรประชาชนหมดอายุ:</label>
                                            <input type="date" name="exp_card_number" class="form-control" id="exp_card_number" placeholder="วันหมดอายุ">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group col-md-4">
                                            <label for="age">สถานที่ทำงาน :</label>
                                            <input type="text" name="workplace" class="form-control" id="workplace" placeholder="สถานที่ทำงาน">
                                        </div>
                                        <div class="form-group col-md-3">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <div class="input-group date">
                                                ...
                                                <input type="date" name="birth" class="form-control pull-right" >
                                            </div>
                                            <!-- /.input group -->
                                        </div>
                                        <!-- /.form group -->
                        ...
                        <div class="box box-primary">
                            ...
                            <div role="form">
                                ...
                                <div class="box-footer">
                                    ...
                                    <div class="col-md-2">
                                        <button name="btnSubmit1" type="submit" value="Submit" title="บันทึกข้อมุล" class="btn btn-primary pull-left" onclick="return confirm('ยืนยันบันทึกข้อมูล')"><i class="fa fa-save"> บันทึก</i></button>
                                    </div>
                                </div>
                                <!-- /.box-footer -->
                                <!-- /.box-body -->
