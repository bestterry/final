                    ...
                    <div class="col-md-8">
                        <div class="box box-solid">
                            ...
                            <div class="box-footer">
                                <a href="../pdf_file/form_insert.php?customer_id=<?=$customer_id?>" title="พิมพ์" class="btn btn-default pull-left" target="_blank"><i class="fa fa-print"></i> พิมพ์แบบฟอร์ม</a>
                            </div>
                        </div>
                    </div>
                    <!-- /.box -->
