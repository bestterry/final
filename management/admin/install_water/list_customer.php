                            ...
                            <div class="col-md-12">
                                <div class="nav-tabs-custom">
                                    <ul class="nav nav-tabs">
                                        ...
                                        <li>
                                            <a href="#timeline" data-toggle="tab">ส่งเรื่องเบิกอุปกรณ์ &nbsp;
                                                ...
                                                <table id="example" class="table table-bordered table-striped">
                                                    ...
                                                    foreach ($objq_checkstatus as $r ) :?>
                                                        <tr>
                                                            ...
                                                            <td class="text-center"> <a  type="button" class="btn btn-warning btn-sm" title="ตรวจสอบสถานะติดตั้งอุปกรณ์" href="check_status.php?house_id=<?php echo $r["house_id"]?>" ><i class="fa fa-search" ></i></a> </td>
                                            ...
                                            <div class="box-body">
                                                <table id="example" class="table table-bordered table-striped">
                                                    ...
                                                    <tr>
                                                        <th class="text-center">บ้านเลขที่</th>
                                                        <th class="text-center">หมู่ที่</th>
                                                        <th class="text-center">สถานะส่งเรื่องเบิกอุปกรณ์</th>
                                                        <th class="text-center">ส่งเรื่องเบิกอุปกรณ์</th>
                                                    </tr>
                                                    </thead>
                                                    <?php
                                                    ...
                                                    foreach ($objq_check_sent_withdraw as $sent ) :?>
                                                        <tr>
                                                            ...
                                                            <?php if ($sent['status_withdraw_tool'] == 'N') { ?>
                                                                <td class="text-center"> <a type="button" class="btn btn-warning btn-sm" title="ส่งเรื่องเบิกอุปกรณ์" href="algorithm/update_status1.php?user_id=<?=$user_id?>&house_id=<?=$sent["customer_id"]?>&status_id=<?=$sent["status_use_water_id"]?>" onclick="return confirm('ยืนยันส่งข้อมูล')"><i class="fa fa-upload"></i></a> </td>
                                                            <?php }else{
                                                                echo '<td>'.'</td>';
                                                            }?>
                                                        </tr>
                                                ...
                                                <div class="row">
                                                    <table id="example" class="table table-bordered table-striped">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th class="text-center">ส่งสถานะการจ่ายเงิน</th>
                                                        </tr>
                                                        </thead>
                                                        <tr>
                                                            <?php
                                                            ...
                                                            <td class="text-center"> <a type="button" class="btn btn-warning btn-sm" title="ส่งสถานะการจ่ายเงิน" href="pass_withdraw.php?house_id=<?=$succress['house_id']?>" onclick="return confirm('ยืนยันส่งสถานะการจ่ายเงิน')"><i class="fa fa-upload"></i></a> </td>
                                                        </tr>
                                                        <?php
                                                            endforeach;
                                                        ?>
