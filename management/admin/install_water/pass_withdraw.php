            ...
            <form action="algorithm/update_status4.php?house_id=<?php echo $_GET['house_id']?>&employee_id=<?=$obj_employee['employee_id'];?>" method="post">
                <div class="row">
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            foreach ($sql_checkaddress as $check):
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><?=$check['count_tool'].'   '.$check['unit']?></td>
                   ...
                   <div class="col-md-4">
                    ...
                    <div class="col-md-6">
                    <input type="submit" class="btn btn-primary" value="บันทึกจ่ายเงิน" onclick="if(confirm('ยืนยันบันทึกการจ่ายเงิน')) return true; else return false;">
                    <a href="../pdf_file/withdraw_tool.php?house_id=<?= $house_id?>" class="btn btn-default" target="_blank"><i class="fa fa-print"> พิมพ์ใบชำระเงิน </i></a>
                   </div>
                </div>
            </form>
        </section>
