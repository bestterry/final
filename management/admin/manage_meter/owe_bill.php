...
$sql_time = "SELECT * FROM money_management INNER JOIN house ON money_management.house_id=house.house_id WHERE DATE_FORMAT(datatime,'%Y-%m')='$year-$month' AND village_no = '$village_no'";
            ...
            <div class="row">
                    ...
                    <div class="box box-solid">
                        ...
                        <div class="box-body no-padding">
                            <ul class="nav nav-pills nav-stacked">
                                <li><a href="pdf_file/owe_bill.php?village=<?php echo $village_no?>&month=<?php echo $month?>&year=<?php echo $year?>" Target="_blank"><i class="fa fa-minus-square"></i> พิมพ์ใบชำระเงินทั้งหมด </a></li>
                                <li><a href="owe_bill.php?village=<?php echo $village_no?>&month=<?php echo $month?>&year=<?php echo $year?>" data-toggle="modal" data-target="#myModal3"><i class="fa fa-filter"></i> ติดค้างชำระ</a></li>
                            </ul>
                        </div>
                        <!-- /.box-body -->
                    </div>
                ...
                <div class="col-md-9">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 class="box-title">ข้อมูลติดค้างชำระ หมู่ที่<?php echo $village_no?></h3>
                        </div>
                        <!-- /.box-header -->
                        <?php if($objr_village['id']==NULL){?>
                            <font size="4" color="red">ไม่พบข้อมูล</font>
                        <?php }else{ ?>
                        <div class="box-body no-padding">
