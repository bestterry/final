                            ...
                            <form action="manage_meter_confirm.php" class="form-horizontal"  method="get">
                                <div class="box-body">
                                    ...
                                    <div class="box-footer">
                                        <button type="submit" title="บันทึกค่าน้ำ" class="btn btn-success pull-right" onclick="return confirm('ยืนยันบันทึกข้อมูล')"><i class="fa fa-save"> บันทึก</i></button>
                                        <a href="manage_meter.php" type="button" class="btn btn-danger pull-left" onclick="return confirm('กรุณากด ตกลง เพื่อย้อนกลับ')"><i class="fa fa-arrow-circle-o-left"> ย้อนกลับ</i></a>
                                    </div>
                                </div>
                            </form>
                        </div>
