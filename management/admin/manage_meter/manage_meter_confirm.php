    ...
    <div class="content-wrapper">
        ...
        <section class="invoice">
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo DateThai($datatime)?></td>
                            </tr>
            ...
            <div class="row no-print" >
                <div class="col-xs-12">
                    <a href="algorithm/insert_meter.php?house_id=<?=$house_id?>&meter=<?=$meter_sent ?>&employee_id=<?=$obj_employee['employee_id']?>&date=<?=$date;?>" type="button" class="btn btn-success pull-right" onclick="return confirm('ยืนยันบันทึกค่าน้ำ')"><i class="fa fa-save"> บันทึกข้อมูล</i></a>
                </div>
            </div>
        </section>
        <!-- /.conten
