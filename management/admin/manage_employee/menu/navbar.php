<section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
                <li><a href="edit_employee.php"><i class="fa fa-circle-o"></i>จัดการเเก้ไขข้อมูลเจ้าหน้าที่</a></li>
                <li><a href="insert_employee.php"><i class="fa fa-circle-o"></i>เพิ่มรายชื่อเจ้าหน้าที่</a></li>
            </ul>
        </li>
        <!-- ข้อมูลสถิติ  -->
        <li class="treeview">
