                    ...
                    <div class="box box-info">
                        ...
                        <div role="form">
                            <div class="box-body">
                                ...
                                <div class="col-md-2">
                                    <a href="../pdf_file/static_month.php?month_before=<?=$month_before?>&year_before=<?=$year_before?>&month_after=<?=$month_after?>&year_after=<?=$year_after?>&village_no=<?=$village_no?>" type="button" class="btn btn-block btn-primary"><i class="fa fa-print"></i>
                                        พิมพ์</a>
                                </div>
                                <div class="col-md-5"></div>
                            </div>
