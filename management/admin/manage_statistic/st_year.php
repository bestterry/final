                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group col-md-12">
                                        <table id="example" class="table table-bordered table-striped">
                                            ...
                                            <tr>
                                                <th class="text-center"><font color="blue">ปี พ.ศ.</font></th>
                                                <th class="text-center"><font color="blue">จำนวนค่าน้ำที่ใช้ทั้งหมด</font></th>
                                        ...
                                        <div class="col-md-2">
                                            <a href="../pdf_file/static_year.php?year_before=<?=$year_before?>&year_after=<?=$year_after?>" type="button" class="btn btn-block btn-primary"><i class="fa fa-print"></i>
                                                พิมพ์</a>
                                        </div>
                                        <div class="col-md-5"></div>
                                    </div>
